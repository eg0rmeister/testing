...
std::any IRVisitor::visitProg(ExprParser::ProgContext* ctx) {
  ...
  llvm::Function* func = llvm::Function::Create(
      func_type, llvm::Function::ExternalLinkage, func_name, TheModule);
  llvm::BasicBlock* func_block =
      llvm::BasicBlock::Create(TheContext, func_name + "bb", func);
...
std::any IRVisitor::visitFun(ExprParser::FunContext* context) {
  ...
  vector<string> args =
      std::any_cast<vector<string>>(context->arguments->accept(this));
  if (!check_unique(args)) {
    throw std::runtime_error("Some argument appears in definition of " +
                             func_name + " multiple times!\n");
  }
  llvm::ArrayRef<llvm::Type*> arguments(
      std::vector<llvm::Type*>(args.size(), Builder.getInt32Ty()));

  llvm::FunctionType* func_type =
      llvm::FunctionType::get(Builder.getInt32Ty(), arguments, false);
  llvm::Function* func = llvm::Function::Create(
      func_type, llvm::Function::ExternalLinkage, func_name, TheModule);
  llvm::BasicBlock* func_block =
      llvm::BasicBlock::Create(TheContext, func_name + "bb", func);
  ...
  if (context->return_expr == nullptr) {
    ...
    Builder.CreateRet(
        std::any_cast<llvm::Value*>(context->return_expr->accept(this)));
  }
...
void IRVisitor::printIR() { TheModule.print(llvm::outs(), nullptr); }

void IRVisitor::printIR(std::string filename) {
  std::error_code ec;
  llvm::raw_fd_ostream outputFile(filename, ec, llvm::sys::fs::OpenFlags());
...
std::any IRVisitor::visitPrintStmt(ExprParser::StmtContext* ctx) {
  ...
  auto formatted_int_string =
      Builder.CreateBitCast(string_int_alloca, Builder.getInt8PtrTy());

  Builder.CreateCall(
      printf_func, {formatted_int_string,
...
std::any IRVisitor::visitIfStmt(ExprParser::StmtContext* ctx) {
  llvm::BasicBlock* if_block =
      llvm::BasicBlock::Create(TheContext, "btrue", current_function);
  llvm::BasicBlock* else_block = nullptr;
  if (ctx->elsestmt != nullptr) {
    else_block =
        llvm::BasicBlock::Create(TheContext, "bfalse", current_function);
  }
  llvm::BasicBlock* rest_block =
      llvm::BasicBlock::Create(TheContext, "bend", current_function);
  if (else_block == nullptr) {
    else_block = rest_block;
  }
  Builder.CreateCondBr(std::any_cast<llvm::Value*>(ctx->ifexp->accept(this)),
                       if_block, else_block);
...
std::any IRVisitor::visitNumberExpr(ExprParser::ExprContext* ctx) {
  return static_cast<llvm::Value*>(llvm::ConstantInt::get(
      Builder.getInt32Ty(), llvm::APInt(32, std::stoi(ctx->getText()), true)));
}
...
std::any IRVisitor::visitVarIdentExpr(ExprParser::ExprContext* ctx) {
  llvm::AllocaInst* alloca_inst =
      NamedVariables.at(ctx->variable_ident->getText());
  return static_cast<llvm::Value*>(
      Builder.CreateLoad(Builder.getInt32Ty(), alloca_inst));
}
...
std::any IRVisitor::visitFunExpr(ExprParser::ExprContext* ctx) {
  ...
  vector<llvm::Value*> arguments =
      std::any_cast<vector<llvm::Value*>>(ctx->arguments->accept(this));
...
std::any IRVisitor::visitMoreExpr(ExprParser::ExprContext* ctx) {
  ...
  return Builder.CreateCmp(llvm::CmpInst::Predicate::ICMP_SGT, lhs, rhs);
}

std::any IRVisitor::visitLessExpr(ExprParser::ExprContext* ctx) {
  llvm::Value* lhs = std::any_cast<llvm::Value*>(ctx->left->accept(this));
  llvm::Value* rhs = std::any_cast<llvm::Value*>(ctx->right->accept(this));
  return Builder.CreateCmp(llvm::CmpInst::Predicate::ICMP_SLT, lhs, rhs);
}

std::any IRVisitor::visitEqualExpr(ExprParser::ExprContext* ctx) {
  llvm::Value* lhs = std::any_cast<llvm::Value*>(ctx->left->accept(this));
  llvm::Value* rhs = std::any_cast<llvm::Value*>(ctx->right->accept(this));
  return Builder.CreateCmp(llvm::CmpInst::Predicate::ICMP_EQ, lhs, rhs);
}

std::any IRVisitor::visitNotEqualExpr(ExprParser::ExprContext* ctx) {
  llvm::Value* lhs = std::any_cast<llvm::Value*>(ctx->left->accept(this));
  llvm::Value* rhs = std::any_cast<llvm::Value*>(ctx->right->accept(this));
  return Builder.CreateCmp(llvm::CmpInst::Predicate::ICMP_NE, lhs, rhs);
}

std::any IRVisitor::visitLessOrEqualExpr(ExprParser::ExprContext* ctx) {
  llvm::Value* lhs = std::any_cast<llvm::Value*>(ctx->left->accept(this));
  llvm::Value* rhs = std::any_cast<llvm::Value*>(ctx->right->accept(this));
  return Builder.CreateCmp(llvm::CmpInst::Predicate::ICMP_SLE, lhs, rhs);
}

std::any IRVisitor::visitMoreOrEqualExpr(ExprParser::ExprContext* ctx) {
  llvm::Value* lhs = std::any_cast<llvm::Value*>(ctx->left->accept(this));
  llvm::Value* rhs = std::any_cast<llvm::Value*>(ctx->right->accept(this));
  return Builder.CreateCmp(llvm::CmpInst::Predicate::ICMP_SGE, lhs, rhs);
}
